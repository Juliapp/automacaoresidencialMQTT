...
const TOPIC_ILUMINACAO_JARDIM_MAX = 'JARDIM/ILUMINACAO/MAX';
const TOPIC_ILUMINACAO_JARDIM_MIN = 'JARDIM/ILUMINACAO/MIN';

const TOPIC_ILUMINACAO_INTERNO = 'INTERNO/ILUMINACAO/VALOR';

const TOPIC_ILUMINACAO_GARAGEM = 'GARAGEM/ILUMINACAO/VALOR';
const TOPIC_ILUMINACAO_GARAGEM_MAX = 'GARAGEM/ILUMINACAO/MAX';
const TOPIC_ILUMINACAO_GARAGEM_MIN = 'GARAGEM/ILUMINACAO/MIN';

const TOPIC_ARCONDICIONADO = 'AC/VALOR';
const TOPIC_ARCONDICIONADO_TEMPERATURA = 'AC/TEMPERATURA';
const TOPIC_ARCONDICIONADO_MAX = 'AC/MAX';
const TOPIC_ARCONDICIONADO_MIN = 'AC/MIN';
const TOPIC_ARCONDICIONADO_AUSENCIA_PESSOAS = 'AC/AUSENCIA_PESSOAS';
